...
public class GetCategoryByidModel {
  ...
  String id,cat_id,name,price,discounted_price,discounted_percentage,image,
    ...
    public GetCategoryByidModel(String id, String cat_id, String name,
                                String price,String discounted_price,String discounted_percentage
                               , String image,String image1,String image2,String image3,
                                String image4
                                , String color,
                                String age, String status,
                                String created_at, String updated_at,
                                String description,String total_cart) {
