...
public class RelatedproductsModel {
  String id,cat_id, name,price,discounted_price,discounted_percentage,image,
          image1,image2,image3,image4,color,age,status,created_at,updated_at,

    description;


    public RelatedproductsModel(String id, String cat_id, String name,
                                String price, String discounted_price,
