package com.healthcare.dogtraining.ui;
...
public class VideoViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            truitonTask.execute("https://www.youtube.com/watch?v=8saOHjoDX94");
        }
        ...
        private class RTSPUrlTask extends AsyncTask<String, Void, String> {
            ...
            public String getRTSPVideoUrl(String urlYoutube) {
                try {
                    String gdy = "https://www.youtube.com/watch?v=8saOHjoDX94";
