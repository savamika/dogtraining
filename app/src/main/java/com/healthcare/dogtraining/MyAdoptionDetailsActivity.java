...
public class MyAdoptionDetailsActivity extends AppCompatActivity {
    String ID;
    ...
    private void GetAdoptByIdApi(String ID) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BaseUrl + getAdoptbyid,
                        ...
                        try {
                            ...
                            if (result.equals("true")) {
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    ...
                                    adapter = new ImagesAdapteradoptiondetails(getImagesModels, MyAdoptionDetailsActivity.this);
                                    RecyclerView.LayoutManager mLayoutManger = new LinearLayoutManager(MyAdoptionDetailsActivity.this);
                                    recyclerview.setLayoutManager(mLayoutManger);
                                    recyclerview.setLayoutManager(new LinearLayoutManager(MyAdoptionDetailsActivity.this, RecyclerView.HORIZONTAL, false));
                                    ...
                                    try {
                                        ...
                                        Glide.with(MyAdoptionDetailsActivity.this)
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progress_view.setVisibility(View.INVISIBLE);
                        Toast.makeText(MyAdoptionDetailsActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
        ...
        VolleySingleton.getInstance(MyAdoptionDetailsActivity.this).addToRequestQueue(stringRequest);
    }
